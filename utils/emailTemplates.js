export function generateVerificationOtpTemplate(otpCode) {
	...
	<p style="font-size: 16px; color: #ccc">
		This code is valid for 15 minutes. Please do not share this code with
		anyone.
	</p>
	<p style="font-size: 16px; color: #ccc">
...
export function generateForgotPasswordEmailTemplate(resetPasswordUrl) {
	...
	">
		...
		<p style="font-size: 16px; color: #ccc">
			If the button above doesn’t work, copy and paste the following URL into
			your browser:
		</p>

		<p style="font-size: 16px; color: #fff; word-break: break-word">
			${resetPasswordUrl}
		</p>
